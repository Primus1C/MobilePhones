...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ПараметрыФормы = Новый Структура("Отбор, СформироватьПриОткрытии, КлючВарианта", УсловияОтбора, Истина, "ХронологияИнвойса");
	...
	ПараметрыФормы.Вставить("КлючВарианта", "ХронологияИнвойса");
